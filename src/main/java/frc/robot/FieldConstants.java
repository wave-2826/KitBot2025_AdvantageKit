...
/**
 * Field-related constants for the 2025 game. All measurements are by default relative to the blue
 * alliance.
 */
public class FieldConstants {
  ...
  /**
   * A level on the reef. This enum is organized so its ordinal represents the 0-indexed level
   * number.
   */
  public enum ReefLevel {
    ...
    /**
     * The offset outward from the back of the branch post. Used for fudge factors only; this
     * doesn't hold significance for how we score.
     */
  ...
  public static final Translation2d reefCenter =
      new Translation2d(Units.inchesToMeters(176.746), fieldWidth / 2.);
  ...
  public enum ReefBranch {
    ...
    private static final LoggedTunableNumber fudgeFactorScalar =
        new LoggedTunableNumber("FieldConstants/FudgeFactorScalar", 1.0);
    ...
    public Translation2d getFudge(boolean isRed, ReefLevel level) {
      ...
      Translation2d standardPostLocation =
          baseFudge.rotateBy(face.getFieldAngle().plus(Rotation2d.k180deg));
  ...
  public enum ReefFace {
    ...
    /**
     * Gets the angle that the robot should move at when lining up with this face for the given
     * alliance -- the angle facing into it.
     */
    ...
    /**
     * Gets the angle that the robot should move at when lining up with this face for the current
     * alliance -- the angle facing into it.
     */
    ...
    public Pose2d getLeftBranchPose() {
      return blueTagPose.transformBy(
          new Transform2d(
              -reefBranchInset.in(Meters),
              -reefBranchSeparation.in(Meters) / 2.,
              Rotation2d.kZero));
    }
    ...
    public Pose2d getRightBranchPose() {
      return blueTagPose.transformBy(
          new Transform2d(
              -reefBranchInset.in(Meters), reefBranchSeparation.in(Meters) / 2., Rotation2d.kZero));
    }
  }
}
